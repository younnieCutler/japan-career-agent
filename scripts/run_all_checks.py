...
CHECKS = (
    ...
    ("test registration", (PYTHON, "scripts/check_test_registration.py")),
    ...
    ("docs drift", (PYTHON, "scripts/check_docs_drift.py")),
    ("docs drift tests", (PYTHON, "scripts/test_docs_drift.py")),
    ("release consistency", (PYTHON, "scripts/check_release_consistency.py")),
    ("version sync", (PYTHON, "scripts/sync_version.py", "--check")),
    ...
    ("career-agent GUI design system", (PYTHON, "skills/career-agent/gui/test_design_system.py")),
    (
        "career-agent GUI product localization",
        (PYTHON, "skills/career-agent/gui/test_product_localization.py"),
    ),
    ("career-agent GUI scale states", (PYTHON, "skills/career-agent/gui/test_scale_states.py")),
    ...
    (
        "career-agent workflow sessions",
        (PYTHON, "skills/career-agent/test_workflow_sessions_v2.py"),
    ),
