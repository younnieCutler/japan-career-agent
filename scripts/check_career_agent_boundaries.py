...
OWNED_SYMBOLS = {
    ...
    "validate_skill_selection": "validation",
    "validate_skill_result": "validation",
    "validate_execution_plan": "validation",
    ...
    "select_skill": "routing",
    "discover": "skill_registry",
    "find": "skill_registry",
    "open_invocation": "skill_invocations",
    "report_invocation": "skill_invocations",
    "open_invocations": "skill_invocations",
    "create_plan": "execution_plans",
    "next_step": "execution_plans",
    ...
    "judgment_ledger": "judgments",
    "record_initial_judgment": "judgments",
    "record_agent_assessment": "judgments",
    "record_final_judgment": "judgments",
    ...
    "monthly_career_projection": "monthly",
