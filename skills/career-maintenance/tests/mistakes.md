# career-maintenance — Mistakes Log

Append-only. One row per real failure this skill produced in actual use — an invented metric, a
team result attributed to the user, a track question that should not have been asked, confidential
material saved verbatim, urgency where none was warranted. Not speculative edge cases; those go in
`tests/eval.md`. Only log something that actually happened.
