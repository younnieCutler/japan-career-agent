...
JUDGMENT_TEXT: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "judgment.waiting_body": "최초 판단은 저장되었습니다. Agent 분석이 기록되면 비교 결과가 표시됩니다.",
    ...
    "ja": {
        ...
        "judgment.waiting_body": "最初の判断は保存済みです。Agent分析が記録されると比較結果を表示します。",
    ...
    "en": {
        ...
        "judgment.waiting_body": "Your initial judgment is saved. The comparison appears after an Agent assessment is recorded for this decision.",
