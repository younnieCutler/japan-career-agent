...
# Section 12.1 rule 4: relevance must be a mechanical match. Every canonical stage is listed
# explicitly so a newly introduced stage fails closed until its personal-data needs are reviewed.
# An empty set is intentional: opportunity discovery and company/JD research do not need personal
# facts merely to inspect the market or an employer.
