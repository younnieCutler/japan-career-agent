...
# Canonical chuto lifecycle. These labels are mirrored in japan-career-flow.toml and checked by
# lifecycle/routing tests. Stage count is allowed to differ from the coarser 0-7 pipeline scale:
# discovery and company/JD analysis are two user-visible steps that both project to market stage 2.
CHUTO_STAGES = (
    "自己分析・転職軸",
    "応募基盤・職務経歴書",
    "求人探索・候補整理",
...
SKILL_BY_STAGE = {
    ...
    "応募基盤・職務経歴書": "job-seeker-agent",
    "求人探索・候補整理": "career-agent",
    "企業研究・JD分析": "kigyou-bunseki",
    "ES・履歴書": "job-seeker-agent",
    "適性検査（SPI3）": "job-seeker-agent",
    "書類選考・面接": "job-seeker-agent",
    "応募・書類選考": "career-document",
    "面接・選考": "job-seeker-agent",
    "内々定・内定・入社準備": "job-seeker-agent",
    "内定・条件交渉": "tenshoku-strategy",
    "退職・引き継ぎ": "tenshoku-strategy",
    "入社準備・オンボーディング": "tenshoku-strategy",
}
REFERENCE_BY_STAGE = {
    "自己分析・就活軸": ("references/questions.md",),
    "自己分析・転職軸": ("references/questions.md",),
    "学チカ・自己PR素材": ("references/shinsotsu.md",),
    "応募基盤・職務経歴書": ("references/shokumukeireki-saigensei.md",),
    "求人探索・候補整理": ("references/opportunity-discovery.md",),
    "企業研究・JD分析": ("references/frameworks.md",),
    "ES・履歴書": ("references/shinsotsu.md",),
    "適性検査（SPI3）": ("references/tekisei-kensa.md",),
    "書類選考・面接": ("references/mensetsu-rounds.md",),
    "面接・選考": ("references/mensetsu-rounds.md",),
    "内々定・内定・入社準備": ("references/naitei-taiou.md",),
    "内定・条件交渉": ("references/naitei-taiou.md",),
    "退職・引き継ぎ": ("references/enman-taishoku.md",),
    "入社準備・オンボーディング": ("references/nyusha-teichaku.md",),
}
...
SKILL_EXECUTION = {
    ...
    "trim": "host_required",
    "factcheck": "host_required",
    "challenge": "host_required",
    ...
    "intent": "host_required",
    "verify": "host_required",
